        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-1">
              <Link href="/" className={linkCls("/")} id="nav-home">
                Home
              </Link>
              <Link href="/about" className={linkCls("/about")} id="nav-about">
                About
              </Link>
            </div>
            ...
            >
              <span
                className={`block h-0.5 w-5 bg-zinc-400 rounded-full transition-all duration-300 ${menuOpen ? "rotate-45 translate-y-2" : ""}`}
              />
              <span
                className={`block h-0.5 w-5 bg-zinc-400 rounded-full transition-all duration-300 ${menuOpen ? "opacity-0 scale-x-0" : ""}`}
              />
              <span
                className={`block h-0.5 w-5 bg-zinc-400 rounded-full transition-all duration-300 ${menuOpen ? "-rotate-45 -translate-y-2" : ""}`}
              />
        ...
        >
          ...
          >
            ...
            >
              {user ? (
                <>
                  <p className="px-4 pb-2 text-xs font-semibold text-zinc-600 uppercase tracking-widest">
                    Account
                  </p>
